...
def allupload(request):
      try:        
        ...
        return render_to_response('polls/upload.html',{'image_error':"please use English"}) 
...
def showall(request):
      ...
      return render_to_response('polls/showall.html',{'photo_list':photo_list,'text_list':text_list,'phototextmap_list':phototextmap_list})
...
def showmore(request,phototextmapPhotoTextMap_phototitle):
      ...
      photo_list= Photo.objects.all()
      phototextmap_list=PhotoTextMap.objects.all()
      return render_to_response('polls/showmore.html',{'photo_list':photo_list,'phototextmap_list':phototextmap_list,'t':t})
